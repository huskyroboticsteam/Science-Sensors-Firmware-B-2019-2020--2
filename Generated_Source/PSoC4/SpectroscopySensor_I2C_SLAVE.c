/***************************************************************************//**
* \file SpectroscopySensor_I2C_SLAVE.c
* \version 4.0
*
* \brief
...
volatile uint8 SpectroscopySensor_slStatus;          /* Slave Status */

/* Receive buffer variables */
volatile uint8 * SpectroscopySensor_slWrBufPtr;      /* Pointer to Receive buffer  */
volatile uint32  SpectroscopySensor_slWrBufSize;     /* Slave Receive buffer size  */
volatile uint32  SpectroscopySensor_slWrBufIndex;    /* Slave Receive buffer Index */

/* Transmit buffer variables */
volatile uint8 * SpectroscopySensor_slRdBufPtr;      /* Pointer to Transmit buffer  */
volatile uint32  SpectroscopySensor_slRdBufSize;     /* Slave Transmit buffer size  */
volatile uint32  SpectroscopySensor_slRdBufIndex;    /* Slave Transmit buffer Index */
volatile uint32  SpectroscopySensor_slRdBufIndexTmp; /* Slave Transmit buffer Index Tmp */
volatile uint8   SpectroscopySensor_slOverFlowCount; /* Slave Transmit Overflow counter */

#if (SpectroscopySensor_I2C_CUSTOM_ADDRESS_HANDLER_CONST)

    uint32 (*SpectroscopySensor_customAddressHandler)(void) = NULL;

    /*******************************************************************************
    * Function Name: SpectroscopySensor_SetI2cAddressCustomInterruptHandler
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    void SpectroscopySensor_SetI2cAddressCustomInterruptHandler(uint32 (*func) (void))
    {
        ...
        SpectroscopySensor_customAddressHandler = func;
    }
#endif /* (SpectroscopySensor_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */


/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveStatus
****************************************************************************//**
*
...
*   - SpectroscopySensor_I2C_SSTAT_RD_CMPLT - Slave read transfer complete. 
...
*   - SpectroscopySensor_I2C_SSTAT_RD_BUSY - Slave read transfer is in progress. 
*     Set when master addresses slave with a read, cleared when 
*    SpectroscopySensor_I2C_SSTAT_RD_CMPLT is set.
*   - SpectroscopySensor_I2C_SSTAT_RD_OVFL - Master attempted to read more bytes
*     than are in buffer. Slave continually returns 0xFF byte in this case.
*   - SpectroscopySensor_I2C_SSTAT_RD_ERR - Slave captured error on the bus during 
*     a read transfer. The sources of error are: misplaced Start or Stop 
*     condition or lost arbitration while slave drives SDA.
*   - SpectroscopySensor_I2C_SSTAT_WR_CMPLT - Slave write transfer complete. 
...
*     successfully.
*   - SpectroscopySensor_I2C_SSTAT_WR_BUSY - Slave write transfer is in progress. 
*     Set when the master addresses the slave with a write, cleared when 
*    SpectroscopySensor_I2C_SSTAT_WR_CMPLT is set.
*   - SpectroscopySensor_I2C_SSTAT_WR_OVFL - Master attempted to write past end of 
*     buffer. Further bytes are ignored.
*   - SpectroscopySensor_I2C_SSTAT_WR_ERR - Slave captured error on the bus during
...
*     SpectroscopySensor_I2C_SSTAT_WR_ERR is set. It is recommended to discard write 
...
{
    return((uint32) SpectroscopySensor_slStatus);
}


/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveClearReadStatus
****************************************************************************//**
*
...
*
* \sideeffect
*  This function does not clear SpectroscopySensor_I2C_SSTAT_RD_BUSY.
*
* \globalvars
*  SpectroscopySensor_slStatus  - used to store current status of I2C slave.
*
...
uint32 SpectroscopySensor_I2CSlaveClearReadStatus(void)
{
    ...
    status = ((uint32) SpectroscopySensor_slStatus & SpectroscopySensor_I2C_SSTAT_RD_MASK);
    SpectroscopySensor_slStatus &= (uint8) ~SpectroscopySensor_I2C_SSTAT_RD_CLEAR;
...
/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveClearWriteStatus
****************************************************************************//**
*
...
*
* \sideeffect
*  This function does not clear SpectroscopySensor_I2C_SSTAT_WR_BUSY.*
*
* \globalvars
*  SpectroscopySensor_slStatus  - used to store current status of I2C slave.
*
...
uint32 SpectroscopySensor_I2CSlaveClearWriteStatus(void)
{
    ...
    /* Mask of transfer complete flag and Error status */
    status = ((uint32) SpectroscopySensor_slStatus & SpectroscopySensor_I2C_SSTAT_WR_MASK);
    SpectroscopySensor_slStatus &= (uint8) ~SpectroscopySensor_I2C_SSTAT_WR_CLEAR;
...
/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveSetAddress
****************************************************************************//**
*
...
void SpectroscopySensor_I2CSlaveSetAddress(uint32 address)
{
    ...
    matchReg = SpectroscopySensor_RX_MATCH_REG;

    matchReg &= ((uint32) ~SpectroscopySensor_RX_MATCH_ADDR_MASK); /* Clear address bits */
    matchReg |= ((uint32)  SpectroscopySensor_GET_I2C_8BIT_ADDRESS(address));

    SpectroscopySensor_RX_MATCH_REG = matchReg;
}


/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveSetAddressMask
****************************************************************************//**
*
...
void SpectroscopySensor_I2CSlaveSetAddressMask(uint32 addressMask)
{
    ...
    matchReg &= ((uint32) ~SpectroscopySensor_RX_MATCH_MASK_MASK);
    matchReg |= ((uint32) (addressMask << SpectroscopySensor_RX_MATCH_MASK_POS));
...
*
* \globalvars
*  SpectroscopySensor_slRdBufPtr   - used to store pointer to slave read buffer.
*  SpectroscopySensor_slRdBufSize  - used to store salve read buffer size.
*  SpectroscopySensor_slRdBufIndex - used to store current index within slave
*  read buffer.
*
*******************************************************************************/
void SpectroscopySensor_I2CSlaveInitReadBuf(uint8 * rdBuf, uint32 bufSize)
{
    ...
    if(NULL != rdBuf)
    {
        ...
        SpectroscopySensor_slRdBufPtr      = (volatile uint8 *) rdBuf; /* Set buffer pointer  */
        SpectroscopySensor_slRdBufSize     = bufSize;                  /* Set buffer size     */
        SpectroscopySensor_slRdBufIndex    = 0u;                       /* Clear buffer index  */
        SpectroscopySensor_slRdBufIndexTmp = 0u;                       /* Clear buffer index  */
...
/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveInitWriteBuf
****************************************************************************//**
*
*  Sets the buffer pointer and size of the write buffer. This function also 
*  resets the transfer count returned with the 
*  SpectroscopySensor_I2CSlaveGetWriteBufSize() function.
*
...
*
* \globalvars
*  SpectroscopySensor_slWrBufPtr   - used to store pointer to slave write buffer.
*  SpectroscopySensor_slWrBufSize  - used to store salve write buffer size.
...
void SpectroscopySensor_I2CSlaveInitWriteBuf(uint8 * wrBuf, uint32 bufSize)
{
    ...
    if(NULL != wrBuf)
    {
        ...
        SpectroscopySensor_slWrBufPtr   = (volatile uint8 *) wrBuf; /* Set buffer pointer  */
        SpectroscopySensor_slWrBufSize  = bufSize;                  /* Set buffer size     */
        SpectroscopySensor_slWrBufIndex = 0u;                       /* Clear buffer index  */
...
/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveGetReadBufSize
****************************************************************************//**
*
*  Returns the number of bytes read by the I2C master since an
*  SpectroscopySensor_I2CSlaveInitReadBuf() or 
*  SpectroscopySensor_I2CSlaveClearReadBuf() function was executed.
...
*
* \sideeffect
*  The returned value is not valid if SpectroscopySensor_I2C_SSTAT_RD_ERR was 
...
{
    return(SpectroscopySensor_slRdBufIndex);
}


/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveGetWriteBufSize
****************************************************************************//**
*
*  Returns the number of bytes written by the I2C master since an
*  SpectroscopySensor_I2CSlaveInitWriteBuf() or 
*  SpectroscopySensor_I2CSlaveClearWriteBuf() function was executed.
...
*
* \sideeffect
*  The returned value is not valid if SpectroscopySensor_I2C_SSTAT_WR_ERR was 
*  captured by the slave.
*
* \globalvars
*  SpectroscopySensor_slWrBufIndex - used to store current index within slave
...
{
    return(SpectroscopySensor_slWrBufIndex);
}


/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveClearReadBuf
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SpectroscopySensor_I2CSlaveClearWriteBuf
****************************************************************************//**
*
